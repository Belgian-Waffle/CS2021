...
int main(void) {
	...
	printf("by using\|\"\,\ orthe ability of the \|\ to escape\,\ by using \|\|\.\\n");
	printf("A stray\|\,\ say \|\z\,\ in a string constant wil have\n");
	printf("different effects on different compliers\.\\n");
	...
	printf("\"\ |n|r|t|a|||'|"" is a string of escape sequence characters\.\\n");
